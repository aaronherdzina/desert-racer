...
func set_next_preview_move_tile():
	var preview_tile_option = current_tile
	if len(preview_move_tiles) > 1:
		preview_tile_option = preview_move_tiles[len(preview_move_tiles)-2]
	elif len(preview_move_tiles) > 0:
		preview_tile_option = preview_move_tiles[len(preview_move_tiles)-1]
