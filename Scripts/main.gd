...
## IMGS
const rock1 = preload("res://Sprites/objects/minimalist/outlined imgs/rock1.png")
const rock2 = preload("res://Sprites/objects/minimalist/outlined imgs/rock b outline2 rocks.png")
...
const tri_tree = preload("res://Sprites/objects/minimalist/outlined imgs/tri tree blue outline.png")
