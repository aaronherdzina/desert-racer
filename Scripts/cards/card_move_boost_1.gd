...
func set_unique_details():
	details.title = 'MOVE BOOST 3'
	details.buff_length = 3
	details.buff_value = 3
	details.buff_type = 'move_up'
	details.type = ['buff']
	details.description = 'Move Cards + 1 distance for ' + str(details.buff_length) + ' rounds'
